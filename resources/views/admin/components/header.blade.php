  <!-- ======= Header ======= -->
  <header id="header" class="header fixed-top d-flex align-items-center" style="background: #3C8DBC;">
    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu sbg_color dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6 class="text-white">Kevin Anderson</h6>
            ...
            <li>
              <a class="dropdown-item hpro_item d-flex align-items-center" href="users-profile.html">
